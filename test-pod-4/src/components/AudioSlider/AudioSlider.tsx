...
export function AudioSlider({ value, onChange }: IAudioSliderProps) {
    ...
    const { ref } = useMove(({ y }) => {
        const newValue = 1 - y; // Convert y position to value between 0 and 1
        ...
        <Group justify="center">
            ...
            >
                ...
                <div
                    style={{
                        position: 'absolute',
                        bottom: `calc(${sliderValue * 100}% - ${rem(8)})`,
                        left: 0,
                        width: rem(35),
                        height: rem(16),
